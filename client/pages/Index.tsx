  ...
  const highlightedBids = [
    {
      ...
      name: "Rahul Joseph",
      handle: "@rahul.joseph",
      reach: "74K reach • Kozhikode, Kerala",
      amount: "₹7,800",
      status: "In review",
    ...
    },
    {
      ...
      reach: "68K reach • Kozhikode, Kerala",
      amount: "₹9,200",
      status: "Shortlisted",
    ...
    },
    {
      ...
      name: "Asha Kurup",
      handle: "@asha.creates",
      reach: "59K reach • Kozhikode, Kerala",
      amount: "₹6,500",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-gray-900 text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr] sm:gap-8">
