                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
                      ...
                      <div className="flex sm:flex-col sm:text-right items-center sm:items-end justify-between sm:justify-start gap-2 sm:gap-1">
                        ...
                        <Badge className={submission.status === 'pending' ? 'bg-yellow-100 text-yellow-800 hover:bg-yellow-100' : submission.status === 'approved' ? 'bg-green-100 text-green-800 hover:bg-green-100' : 'bg-red-100 text-red-800 hover:bg-red-100'}>
      ...
      {selectedEvidence && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50">
          <Card className="w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
            <CardHeader>
              <CardTitle className="text-lg sm:text-xl">Review Evidence: {campaign.title}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Influencer Details</h4>
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Avatar className="h-10 w-10 sm:h-12 sm:w-12">
                      <AvatarImage src={selectedEvidence.influencerAvatar} />
                      <AvatarFallback>{selectedEvidence.influencerName.charAt(0)}</AvatarFallback>
                    </Avatar>
                    <div>
                      <h5 className="font-medium text-gray-900 text-sm sm:text-base">{selectedEvidence.influencerName}</h5>
                      <p className="text-xs sm:text-sm text-gray-600">{selectedEvidence.influencerHandle}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-green-600">${selectedEvidence.amount}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Submitted:</span>
                      <span className="font-medium">{new Date(selectedEvidence.submittedAt).toLocaleDateString()}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Evidence Links</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Submission Description</h4>
                <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                  <p className="text-gray-700 text-xs sm:text-sm">{selectedEvidence.evidence.description}</p>
                </div>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Screenshots</h4>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
                  {selectedEvidence.evidence.screenshots.map((screenshot, index) => (
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base">Review Notes (Optional)</h4>
                <Textarea 
